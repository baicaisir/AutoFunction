...
class Testnoxmobi:
    ...
    def setup_class(self):
        ...
        # common.setWinProxy()
        common.changeFileContent('system = (.*)', r'"AdMob", 5, "ios"', Model.proxypath)
    ...
    def test_int_show(self):
        ...
        common.wait(5)
        text = common.getValueById(Noxmobi.interbutton.testmode)
        common.checkValue(text == Noxmobi.interbutton.testmode)
        common.clickById(Noxmobi.interbutton.testmode)
    ...
    #     int = common.logBlockKeywordExist(Model.int_nox_sdk_click, Model.firebaselog)
    #     assert int
