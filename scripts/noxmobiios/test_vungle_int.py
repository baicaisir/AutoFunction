...
class Testnoxmobi:
    ...
    def setup_class(self):
        ...
        # common.setWinProxy()
        common.changeFileContent('system = (.*)', r'"Vungle", 5, "ios"', Model.proxypath)
    ...
    def test_int_show(self):
        ...
        common.swipeDown()
        text = common.getValueById(Noxmobi.vungle.vunglename)
        common.checkValue(text == Noxmobi.vungle.vunglename)
