...
class Testnoxmobi:
    ...
    def setup_class(self):
        ...
        # common.setWinProxy()
        common.changeFileContent('system = (.*)', r'"ByteDance", 3, "ios"', Model.proxypath)
    ...
    def test_reward_show(self):
        ...
        common.clickCenter()
        common.wait(3)
        common.clickById(Noxmobi.bytedance.adrewardclosename)
        common.clickById(Noxmobi.bytedance.adclosename)
